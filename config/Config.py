...
class Config(object):
    ...
    def __init__(self):
        self.PROJECT_PATH = os.path.abspath(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..'))
        base_file = os.path.abspath(os.path.join(self.PROJECT_PATH, 'release/Base.so'))
