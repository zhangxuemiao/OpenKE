...
conR.set_in_path(os.path.join(con.PROJECT_PATH, 'benchmarks/FB15K/'))
...
conR.make_dir(model_res_dir)

# Models will be exported via tf.Saver() automatically.
conR.set_export_files(os.path.join(model_res_dir, 'model.vec.tf'), 0)
# Model parameters will be exported to json files automatically.
conR.set_out_files(os.path.join(model_res_dir, 'embedding.vec.json'))
